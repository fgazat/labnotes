...
description: "Структура полимеров: ближний и дальний порядок, конфигурация и конформация макромолекул, гибкость цепи, внутреннее вращение и потенциальный барьер вращения."
type: docs
sidebar:
  open: true
