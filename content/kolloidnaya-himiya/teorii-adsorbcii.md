...
description: "Теории адсорбции: мономолекулярная теория и уравнение Лэнгмюра, потенциальная теория Поляни, полимолекулярная адсорбция БЭТ, изотермы адсорбции."
type: docs
weight: 7
---
