...
description: "Оптические свойства коллоидных систем: теория светорассеяния и закон Рэлея, эффект Тиндаля, нефелометрия, ультрамикроскопия, электронная микроскопия, окраска золей."
type: docs
weight: 2
math: true
---
