...
description: "Поверхностные явления: переходный слой, ван-дер-ваальсовы взаимодействия, внутреннее давление и поверхностное натяжение, влияние природы жидкости, температуры и кривизны поверхности, капиллярные явления, смачивание и краевой угол."
type: docs
weight: 3
math: true
---
...
Межмолекулярные силы, действующие в переходном слое, — это **ван-дер-ваальсовы взаимодействия** трех видов:

1. **Дисперсионные** — возникают из-за корреляции мгновенных электронных плотностей соседних атомов: в каждом атоме наводятся согласованные мгновенные диполи. Действуют между любыми молекулами.

    ![Дисперсионное взаимодействие: два атома с согласованно смещенными электронными облаками (δ+ и δ−)](images/poverkhnostnye-yavleniya/dispersionnoe-vzaimodejstvie.png)

2. **Диполь-дипольные (ориентационные)** — только для полярных молекул, например воды: постоянные диполи ориентируются друг относительно друга.

    ![Диполь-дипольное взаимодействие: молекула воды с частичными зарядами и два ориентированных диполя](images/poverkhnostnye-yavleniya/dipol-dipolnoe-vzaimodejstvie.png)

3. **Индукционные** — постоянный диполь наводит (индуцирует) диполь в соседней неполярной молекуле.

    ![Индукционное взаимодействие: диполь поляризует соседнюю неполярную молекулу, и она сама становится диполем](images/poverkhnostnye-yavleniya/indukcionnoe-vzaimodejstvie.png)
...
## Влияние различных факторов на Pᵢ и σ
...
**Смачиваемость** — явление взаимодействия жидкости с поверхностью твердого тела. Мерой смачивания служит **краевой угол смачивания** $\theta$ — угол между поверхностью твердого тела и касательной к поверхности капли, отсчитываемый через жидкость.

![Капля на поверхности твердого тела: несмачивающая жидкость собирается в шар, смачивающая растекается; θ — краевой угол смачивания](images/poverkhnostnye-yavleniya/kraevoj-ugol.png)

- $\theta < 90^\circ$ — жидкость смачивает поверхность (капля растекается);
- $\theta > 90^\circ$ — не смачивает (капля собирается в шар).

Действует правило «подобное смачивает подобное»: полярные жидкости хорошо смачивают полярные (гидрофильные) поверхности, неполярные — неполярные (гидрофобные). От смачивания зависит направление капиллярного эффекта: вода, смачивающая стекло, в капилляре поднимается, а несмачивающая ртуть — опускается.
