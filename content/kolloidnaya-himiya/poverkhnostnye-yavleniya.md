...
description: "Поверхностные явления: переходный слой, внутреннее давление и поверхностное натяжение, влияние природы жидкости, температуры и кривизны поверхности, капиллярные явления."
type: docs
weight: 4
math: true
---
