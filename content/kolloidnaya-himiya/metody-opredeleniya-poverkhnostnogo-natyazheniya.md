...
description: "Методы определения поверхностного натяжения: капиллярное поднятие, максимальное давление пузырька (метод Ребиндера), сталагмометрический метод, отрыв кольца."
type: docs
weight: 5
---
