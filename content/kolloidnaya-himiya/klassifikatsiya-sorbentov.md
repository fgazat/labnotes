...
description: Параметры пористой структуры (удельная поверхность, объем пор, ДКР), классификация сорбентов по размеру пор (Дубинин) и виду изотерм сорбции (Киселёв), пористость, механизмы заполнения микро-, мезо- и макропор.
type: docs
weight: 8
---
...
Пористую структуру сорбентов характеризуют:

* **удельная поверхность** S<sub>уд</sub> (м²/г) — сумма поверхностей всех пор, отнесенная к единице массы сорбента;
* **суммарный объем пор** W<sub>0</sub> (см³/г) — сумма объемов пор твердого тела на единицу массы;
* **радиус пор** r;
* **дифференциальные кривые распределения** (ДКР) объемов пор по радиусам.

Удельная поверхность пористых сорбентов лежит в пределах от 1 до 10³ м²/г. Ее определяют:

* электронной микроскопией — фотографируют образец и определяют радиусы частиц и пор;
* методом ультрамикроскопии;
* методом БЭТ (для макро- и мезопор) — по изотерме адсорбции, см. [теории адсорбции](../teorii-adsorbcii/).
