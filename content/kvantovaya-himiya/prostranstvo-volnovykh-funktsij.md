...
description: "Пространство волновых функций: квантовое состояние, волновая функция и её свойства, базис, разложение по базису, нормировка и вероятностный смысл коэффициентов."
weight: 2
type: docs
math: true
---
