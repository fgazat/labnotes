...
description: "Свойства операторов в квантовой механике: линейность, самосопряжённость (эрмитовость), сложение и умножение операторов, коммутирующие операторы и коммутатор."
type: docs
math: true
weight: 4
---
