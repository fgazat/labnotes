...
description: "Основные операторы квантовой механики: операторы координаты, импульса, кинетической, потенциальной и полной энергии, их линейность, самосопряжённость и коммутация."
type: docs
math: true
weight: 3
---
