---
title: Операторные уравнения
description: "Операторные уравнения: собственные функции и собственные значения оператора, примеры с оператором дифференцирования, вырождение, разложение по собственным функциям."
type: docs
math: true
weight: 5
---
