...
description: "Термические коэффициенты в термодинамике: определения, симбатная и антибатная связь, расчёт производных из опытных данных, коэффициент Джоуля — Томсона."
type: docs
---
