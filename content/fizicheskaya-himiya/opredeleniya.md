...
description: "Основные понятия физической химии: предмет и методы, термодинамическая система и виды систем, энергия, теплота и работа, температура, параметры и функции состояния."
