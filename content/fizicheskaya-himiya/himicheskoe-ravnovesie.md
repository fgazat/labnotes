...
description: "Химическое равновесие: вывод изотермы и изобары Вант-Гоффа, константа равновесия, связь Kp и Kc, влияние температуры, давления и добавок на положение равновесия."
type: docs
weigh: 3
---
