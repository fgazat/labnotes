---
title: Второе начало (закон) термодинамики
description: "Второе начало термодинамики: цикл и теорема Карно, теорема Клаузиуса, приведённая теплота, энтропия как функция состояния, вечный двигатель второго рода."
weight: 2
type: docs
sidebar:
  open: true
